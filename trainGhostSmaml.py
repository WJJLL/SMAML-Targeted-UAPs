...
from modules.inception import inception_v3
from modules.vgg import vgg16_bn,vgg16
from collections import OrderedDict
from random import sample
import torch.nn.functional as F
from modules.resnet import resnet50, resnet152
        ...
        while (iteration < args.iterations):
            ...
            for arch in rm_archs:
                ...
                if args.loss_function == "ce":
                    ...
                    loss = self.criterion(adv_out, target)
            ...
            if iteration % 1000 == 0:
                torch.save(self.net.state_dict(),
                           args.save_dir + '/netG_ghostSMaml_{}_{}_{}_{}_{}_{}.pth'.format(args.model_type, args.src,
                                                                                          iteration,
...
def main():
    ...
    model_set = [model_1, model_1]

    criterion = BoundedLogitLossFixedRef(num_classes=1000, confidence=args.confidence, use_cuda=args.use_cuda)
